const entries = [
  ...
  {
    type: 'sequence',
    questionKind: 'ordered-interaction',
  ...
  {
    type: 'data-model',
    questionKind: 'entity-relationship',
  ...
  {
    type: 'timeline',
    questionKind: 'temporal-progression',
  ...
  {
    type: 'layers',
    questionKind: 'layered-enforcement',
